...
Már utalva volt rá, hogy lényegében nem is az alakzatokat kellene összefûzni hanem az iterátorokat. Az összetett alakzat kirajzolásánál is egy alapvetõ problémába ütközünk: hogyan fogjuk végig iterálni az alakzatot. Egyrészt, hogyan fogjuk tudni, hogy egy alakzat végére értünk, másrészt milyen típusú iterátorral fogunk iterálni, ugyanis a különbözõ konténerek iterátorai, külön\-bözõ típusúak, meg hat teljesen azonos is a viselkedésük. A teljesen azonos viselkedés pedig teljesül: feltéve, hogy azonos \verb"scalar" típussal példányosítottuk az alakzatainkat, akkor világos, hogy mindhárom alakzat iterátora egy-egy \verb"vect<scalar>" típusú pontra mutat.
...
\subsubsection{Öröklõdés}

\subsubsection{Virtuális függvények}

\subsubsection{Logikai elemzés}
