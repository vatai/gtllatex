...
Ezek az algoritmusok csak az alakzat input iterátorát használják. Tipikussan a következõ módon alkalmazhatjuk õket (például egy sokszög, a koordináta rendszer elsõ kvadránsába esõ csúcsainak a megszámlálása):
\begin{verbatim}
...
\end{description}
A felsorolt függvény-sablonok paraméter listája nem teljes, ugyanis a \verb'...' helyén, az \verb"input_iterator mit, output_iterator" áll. Például a \verb"move" teljes függvény-sablon prototípusa:
\begin{verbatim}
  template<
    typename input_iterator, 
...
\end{verbatim}
Ezeket a mûveleteket, tipikusan, a következõ módon lehet alkalmazni (most például a \verb"move" mûveletet egy körre):
\begin{verbatim}
...
Az eddig felsorolt, alap algoritmusok mintájára, nagyon könnyel lehet tetszõleges algoritmus implementálni. Láthatjuk, hogy az STL-hez hasonló\-an, csak az iterátorokat, és az algoritmushoz szükséges információt (functort vagy elforgatás szögét), kell átadni. 
