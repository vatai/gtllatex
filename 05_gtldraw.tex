...
\end{verbatim}
De ez nagyon csúnya megoldás lenne, mert igaz, hogy a tárolást megoldaná, és csak ezt a struktúrát kellene módosítani új típusú alakzat hozzáadásakor, de a \verb"node" kiolvasása okozna gondot, azaz egy bonyolult \verb"if/else" elágazást eredményezne, hogy polimorf szerû viselkedést produkáljon. Ez talán megoldható lenne meta-programozással, a \emph{Boost.Function}hoz hasonló módon.
...
\subsubsection{Öröklõdés és virtuális függvények}
Mivel már annyiszor szóba került, vizsgáljuk meg alapvetõen az objektum orientált programozás által nyújtott eszközök, vagyis az öröklõdés és a virtuális függvények elõnyeit és hátrányait a generikus programozás eszközeivel szemben. 
