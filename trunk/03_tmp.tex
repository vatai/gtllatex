...
\end{verbatim}
ugyanis a fordító program nem találhatja ki, milyen számot fog a felhasználó bevinni.
...
\end{verbatim}
Ezt a metaprogramot használva, a következõ program a $42$ számot fogja kiírni:
\begin{verbatim}
int main()
{
